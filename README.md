...
This is a WebCam software for the <kbd>Photon-pixel coupling</kbd> method. The application is made in <kbd>Visual Basic 6.0 (VB6)</kbd>. The WebCam software for the Photon-pixel coupling method takes images at equal intervals (user defined) and saves them as BMP files in a dedicated folder for later analysis using the Vesta software. For more information, please read:
